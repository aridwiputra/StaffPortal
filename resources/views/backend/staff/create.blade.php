              ...
              <div class="card-body col-sm-6">
                ...
                @csrf
                  ...
                  <div class="form-group">
                    ...
                    <input required="" type="text" name="phone" class="form-control" id="phone" placeholder="Enter phone">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input required="" type="text" name="position" class="form-control" id="position" placeholder="Enter position">
                  </div>
